...
export function Footer() {
  return (
    <footer className="retro flex h-14 shrink-0 items-center gap-2 border-t border-dashed">
      <div className="mx-auto flex h-full w-full max-w-[1400px] items-center justify-between gap-1 border-r border-l border-dashed px-4 lg:gap-2 lg:px-6">
